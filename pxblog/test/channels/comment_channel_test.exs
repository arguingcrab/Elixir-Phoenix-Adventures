defmodule Pxblog.CommentChannelTest do
  ...
  @doc """
  Pass socket to test
  Push CREATED_COMMENT to socket
  Cant declare map that ref other var inside of assert_broadcast() so
  setup expected val and pass in expected var to assert_broadcast()
  """
  ...
  # Start off pushing approved val to socket and expect "approved"
  ...
  # Push payload into socket, assert we're broadcasting out that a comment has been deleted
